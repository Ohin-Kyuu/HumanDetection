...
configurable_parameters = [{'name': 'camera_name',                  'default': 'd405', 'description': 'camera unique name'},
                           ...
                           {'name': 'json_file_path',               'default': "/home/camera/capstone-ws/src/realsense-ros/visual_presets/HighAccuracyPreset.json", 'description': 'allows advanced configuration'},
